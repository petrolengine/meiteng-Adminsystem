            ...
            <div className="add_page_common_background">
                <div className="special_frame_xl">
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">位置</label>
                        <input className="add_page_common_value in_top" name="sales_house_location" placeholder="例.靠近万达广场"></input>
                    </div>
                    <div className="b add_page_common_item">
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">类型</label>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">户型</label>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">面积/楼层</label>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">朝向</label>
                        <select className="lx b15_1_ch">
                            <option>东</option>
                            <option>南</option>
                            <option>西</option>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">装修</label>
                        <select className="lx b15_1_ch">
                            <option>普通装修</option>
                            <option>精装修</option>
                            <option>豪华装修</option>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">单价/总价</label>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top">车位/价格</label>
                    ...
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top" >物业公司</label>
                        <input className="add_page_common_value in_top" name="property_management_company"></input>
                    </div>
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top" >信息备注</label>
                        <input className="add_page_common_value in_top" name="sales_remark"></input>
                    </div>
                    <div className="b add_page_common_item">
                        <label className="add_page_common_key w15_2ch in_top" >设施配套</label>
