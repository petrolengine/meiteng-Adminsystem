                    ...
                    <div className="special_frame">
                        ...
                        <div className="info_landlord">
                            <div className="b bk">
                                ...
                                <input className="info_landlord_content in_top" name="guest_name"></input>
                            </div>
                            <div className="b bk">
                                <label className="bkf w15_2ch in_top">性别</label>
                                <div className="info_landlord_bk in_top">
                                    <input id="gender_male" style={{ "marginLeft": " 15px" }} type="radio" name="guest_sex" value="male"></input>
                                    <label className="gender" for="gender_male">男</label>
                                    <input id="gender_female" style={{ "marginLeft": " 15px" }} type="radio" name="guest_sex" value="female"></input>
                                    <label className="gender" for="gender_female">女</label></div>
                            </div>
                            <div className="b bk">
                                <label className="bkf w15_2ch in_top">年龄</label>
                                <input className="info_landlord_content in_top" name="guest_age"></input>
                            </div>
                            <div className="b bk">
                                <label className="bkf w15_2ch in_top">电话</label>
                                <input className="info_landlord_content in_top" name="guest_tele"></input>
                            </div>
                            <div className="b bk">
                                <label className="bkf w15_2ch in_top">籍贯</label>
                                <input className="info_landlord_content in_top" name="guest_obode"></input>
                            </div>
                            <div className="b bk">
                            ...
                            <div className="b bk">
                                <label className="bkf w15_2ch in_top">顾客诉求</label>
                                <input className="info_landlord_content in_top" name="guest_boode"></input>
                            </div>
                        </div>
